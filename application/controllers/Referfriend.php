...
class Referfriend extends CI_Controller {
  ...
  {         $this->load->model('Loginmodel'); 
            ...
            $universitylogo = $this->session->userdata['logged_in']['umsurl']."/Document/Data_".$uid."/".$logo."";
             $this->load->model('Referalmodel');
             ...
             $url = $this->session->userdata['logged_in']['url'];
             $discountamount = $this->Loginmodel->get_discount($this->session->userdata['logged_in']['universityid']);
