...
class Invitation extends CI_Controller {
    ...
    $token = str_replace('=','.', $ref_id);
     ...
     if(stristr($find_uni->LmsURL,'lms1'))
       $ums_link = str_replace('lms1','ums',$find_uni->LmsURL);
     else if(stristr($find_uni->LmsURL,'lms'))
        $ums_link = str_replace('lms','ums',$find_uni->LmsURL);

     //= str_replace('lms','ums',$lms_link);
