                ...
                <tr>
                  ...
                  <?php
                   ...
                   else 
                   {
                    ...
                    <button class="btn btn-info" onclick="send_reminder('<?= $universityid;?>','<?= $row->referalID;?>','<?= $progress_status;?>','<?= $row->Firstname;?>','<?= $row->EmailId;?>','<?= $row->MobileNo;?>');">Send Reminder</button>
