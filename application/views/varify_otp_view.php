        ...
        <div id="msg"></div>
         ...
         <form class="form-horizontal" role="form" method="post" action="<?= base_url()?>Registration_support/Check_otp/<?= $universityid?>">
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" value="<?php echo $this->session->userdata('mobile');?>" readonly required="required" class="form-control" name="number" id="number" placeholder="Enter mobile number" maxlength="10" minlength="10" required>
              </div>
            </div>
            <div class="form-group">
