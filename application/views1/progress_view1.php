    ...
    {   
        ...
        $.ajax({
              ...
              success: function(data) 
              {
                if(data=='1')
                {
                  $("#msg").html('<div class="alert alert-success text-center">Reminder Mail Sent Successfully</div>'); 
                   $('html, body').animate({ scrollTop: 0 }, 0);
                }
                else
                {
                 $("#msg").html('<div class="alert alert-danger text-center">Failed to send reminder mail. Please Try Again!!</div>'); 
                }  $('html, body').animate({ scrollTop: 0 }, 0);               
                  //$("#msg").html(data);
                console.log(data);
              }
     ...
     url = '<?php echo base_url()."Progress_support/hidecontact/'+referalID+'";?>';
        $.ajax({
              ...
              success: function(data) {
                ...
                {
                 $("#msg").html('<div class="alert alert-danger text-center">Failed to hide contact. Please Try Again!!</div>'); 
                }                
                 console.log(data);
              }
            });
