    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box">
          ...
          <label class="callout bg-primary disabled color-palette"><p>YOUR UNIQUE COUPON CODE IS <b><?=$this->session->userdata['logged_in']['referralcode']; ?></b></p></label> <br>
         </div>-->
         <div align="center">
         ...
         <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <a  href="https://accounts.google.com/o/oauth2/auth?client_id=260406686958-je88b0aeajvrlf8g8rejaev988kp4na7.apps.googleusercontent.com&redirect_uri=<?php echo base_url();?>Inviteusers/&scope=https://www.google.com/m8/feeds/&response_type=code"> <span class="info-box-text">Invite Your</span>
              <span class="info-box-number fonttext1">Google Contacts</span></a><span><button type="button" class="btn btn-box-tool" data-widget="collapse" id="helpbutton"><i class="fa fa-question-circle"></i>
                </button><br></span>
          ...
          <div class="box collapsed-box" id="helpbox">
          ...
          <div class="info-box">
            ...
            <a href="<?php echo base_url()?>Referfriend/view/<?= $universityid;?>/1">
              ...
              <span class="info-box-number">Friends </span></a><span><button type="button" class="btn btn-box-tool" data-widget="collapse" id="helpbutton1"><i class="fa fa-question-circle"></i>
                </button><br>
            </div>
             
            <!-- /.info-box-content -->
              <div class="box collapsed-box" id="helpbox1">
          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number" style="text-align: left;"> <input type="text" class="form-control" placeholder="Share this link" id="sharelink" value="<?=$sourcelink?>" onfocus='this.select();' name="sharelink" id="sharelink" readonly="true" style="width:150px;">
              <a  href='<?= $sourcelink?>' class="fonttext"   target = '_blank'>View page</a><button type="button" class="btn btn-box-tool " data-widget="collapse" id="helpbutton2"><i class="fa fa-question-circle"></i>
                </button>
        </span>    </div>
            <!-- /.info-box-content -->
              <div class="box collapsed-box" id="helpbox2">
         ...
         <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <a  href="#" id="sharebtn">
              <span class="info-box-text">Share Your Link</span>
              <span class="info-box-number">On Facebook</span></a><span><button type="button" class="btn btn-box-tool" data-widget="collapse" id="helpbutton3"><i class="fa fa-question-circle"></i>
                </button><br>

            </div>
            <!-- /.info-box-content -->
              <div class="box collapsed-box" id="helpbox3">
