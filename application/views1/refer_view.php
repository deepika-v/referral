...
$("#helpbutton").click(function (){
    if ($("#helpbox").hasClass("box collapsed-box helpbox")) {
        $("#helpbox").removeClass("box collapsed-box helpbox").addClass("box helpbox");
    }
    else if ($("#helpbox").hasClass("box helpbox")) {
        $("#helpbox").removeClass("box helpbox").addClass("box collapsed-box helpbox");
    }
});
$("#helpbutton1").click(function (){
    if ($("#helpbox1").hasClass("box collapsed-box helpbox")) {
        $("#helpbox1").removeClass("box collapsed-box helpbox").addClass("box helpbox");
    }
    else if ($("#helpbox1").hasClass("box helpbox")) {
        $("#helpbox1").removeClass("box helpbox").addClass("box collapsed-box helpbox");
    }

});

$("#helpbutton2").click(function (){
    if ($("#helpbox2").hasClass("box collapsed-box helpbox1")) {
        $("#helpbox2").removeClass("box collapsed-box helpbox1").addClass("box helpbox1");
    }
    else if ($("#helpbox2").hasClass("box helpbox1")) {
        $("#helpbox2").removeClass("box helpbox1").addClass("box collapsed-box helpbox1");
    }

});

$("#helpbutton3").click(function (){
    if ($("#helpbox3").hasClass("box collapsed-box helpbox")) {
        $("#helpbox3").removeClass("box collapsed-box helpbox").addClass("box helpbox");
    }
    else if ($("#helpbox3").hasClass("box helpbox")) {
        $("#helpbox3").removeClass("box helpbox").addClass("box collapsed-box helpbox");
    }
